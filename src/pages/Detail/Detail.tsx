...
const Detail = () => {
  ...
  useEffect(() => {
    document.title = detailState.title || "Great Visual Novel | GVN";
    return () => {
      document.title = "Great Visual Novel | GVN";
    };
  }, [detailState]);
    ...
    <div className="app-wrapper">
      {!errorPatch && (
        <Popup
          title={"Thank you!"}
          description={
            "If you like these free translation patches on this website and want to say thanks, or encourage me to do more, you can consider buying me a coffee or becoming a member!"
          }
          url={url}
          isHide={isHide}
          setIsHide={setIsHide}
