...
router.get("/", verifyRole("User","Supporter","Member", "Admin"), async (req, res) => {
...
router.put("/:userId", verifyRole("User", "Supporter","Member", "Admin"), async (req, res) => {
...
router.delete("/", verifyRole("Admin","Supporter","Member","User"), async (req, res) => {
  const { userId } = req.user;
  try {
